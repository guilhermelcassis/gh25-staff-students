    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      {showConfirmation && (
        <div 
          ...
          onClick={(e) => e.target === e.currentTarget && handleCancelCheckIn()}
        >
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-neutral-500 space-y-1">
                  {currentStaffMember.email && (
                    <p>{currentStaffMember.email}</p>
                  )}
                  {currentStaffMember.country && currentStaffMember.igreja && (
                    <p>{currentStaffMember.country} • {currentStaffMember.igreja}</p>
                  )}
                  {currentStaffMember.area && (
                    <p>Area: {currentStaffMember.area}</p>
                  )}
                  {currentStaffMember.quarto && (
                    <p>Room: {currentStaffMember.quarto}</p>
                  )}
                </div>
              </div>
            </div>
